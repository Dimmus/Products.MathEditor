...
from Products.MathEditor.config import PROJECTNAME, GLOBALS
...
def install(self):
    ...
    setup_tool.setImportContext('profile-Products.MathEditor:default')  # our profile and steps

    # run all import steps
    #steps = ('skins','typeinfo', 'factorytool', 'rolemap')
    #for step in steps:
