...
<xsl:template match="m:mrow[@id]">\matheditor[<xsl:value-of select="@id"/>]{<xsl:apply-templates/>}</xsl:template>
...
<!--  TODO include cnx's stuff: <xsl:include href="cnx_blockmath.xsl"/> -->
...
<!-- ====================================================================== -->
<!-- $Id: scripts.xsl 7979 2005-04-28 23:07:17Z brentmh $
     This file is part of the XSLT MathML Library distribution.
     See ./README or http://www.raleigh.ru/MathML/mmltex for
     copyright and other information                                        -->
<!-- ====================================================================== -->
