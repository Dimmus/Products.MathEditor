...
window.jsMath = {
  ...
  version: "3.6b",  // change this if you edit the file, but don't edit this file
...
jsMath.Translate = {
  ...
  ConvertMath: function (style,element,noCache) {
    ...
    //PHIL element.innerHTML = text;
	try{
    element.innerHTML = text;
	}catch(e){
	    text = text.replace("&nbsp;", " ");
		var node = new DOMParser().parseFromString("<div xmlns='http://www.w3.org/1999/xhtml'>"+text+"</div>", "text/xml");
		//element.appendChild(document.createTextNode(text));
		element.appendChild(node.documentElement);
	}
  },
