...
<!DOCTYPE xsl:stylesheet SYSTEM "http://localhost/~schatzp/mathml-js/xml/originals/unused-moz-mathml.ent">
...
<xsl:stylesheet version="1.0"
  ...
  <xsl:param name="imaginaryi" select="'&ImaginaryI;'" />
...
<xsl:template match="m:cn">
  ...
  <m:mo><xsl:text disable-output-escaping="yes">&InvisibleTimes;</xsl:text></m:mo><m:mi><xsl:value-of select="$imaginaryi"/></m:mi>
      ...
      <xsl:when test="./@type='complex-polar'">
        <m:mrow><m:mn><xsl:value-of select="text()[position()=1]"/></m:mn><m:mo>&angle;</m:mo><m:mn><xsl:value-of select="text()[position()=2]"/></m:mn></m:mrow>
      </xsl:when>
...
<xsl:template match="m:lambda">
  <m:mrow>
    <m:mo><xsl:text disable-output-escaping="yes">&lambda;</xsl:text></m:mo>
    <m:mrow><m:mo>(</m:mo>
...
<xsl:template match="m:apply[child::m:apply[position()=1]/m:compose]">
  <m:mrow> <!-- elementary classical functions have two templates: apply[func] for standard case, func[position()!=1] for inverse and compose case-->
    <xsl:for-each select="m:apply[position()=1]/*[position()!=1 and position()!=last()]">
      <xsl:apply-templates select="."/><m:mo><xsl:text disable-output-escaping="yes">&SmallCircle;</xsl:text></m:mo> <!-- compose functions --><!-- does not work, perhaps compfn, UNICODE 02218-->
...
<xsl:template match="m:apply[child::*[position()=1 and local-name()='rem']]">
  ...
  <m:mrow>  
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="."/><m:mo>&times;</m:mo>
      </xsl:otherwise>
    </xsl:choose>
        </xsl:when>
...
<m:mrow>
  ...
  <xsl:when test="count(*)>=3"> <!-- at least two operands (common case)-->
    ...
    <xsl:for-each select="child::*[position()!=last() and  position()!=1]">
      ...
      <xsl:when test="m:or"> <!--add brackets around OR children for priority purpose-->
        <m:mfenced separators=" "><xsl:apply-templates select="."/></m:mfenced><m:mspace width='.3em'/><m:mo><xsl:text  disable-output-escaping="yes">&and;</xsl:text></m:mo><m:mspace width='.3em'/>
      </xsl:when>
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="."/><m:mspace width='.3em'/><m:mo><xsl:text disable-output-escaping="yes">&and;</xsl:text></m:mo><m:mspace width='.3em'/>
      </xsl:otherwise>
      </xsl:choose>
    </xsl:for-each>
    <xsl:for-each select="child::*[position()=last()]">
  ...
  <xsl:when test="count(*)=2">
    <m:mspace width='.3em'/><m:mo><xsl:text disable-output-escaping="yes">&and;</xsl:text></m:mo><m:mspace width='.3em'/><xsl:apply-templates select="*[position()=last()]"/>
  </xsl:when>
  <xsl:otherwise>
    <m:mspace width='.5em'/><m:mo><xsl:text disable-output-escaping="yes">&and;</xsl:text></m:mo><m:mspace width='.5em'/>
  </xsl:otherwise>
  </xsl:choose>
</m:mrow>
...
<m:mrow>
  ...
  <xsl:when test="count(*)>=3">
    <xsl:for-each select="child::*[position()!=last() and  position()!=1]">
      <xsl:apply-templates select="."/><m:mspace width='.3em'/><m:mo><xsl:text disable-output-escaping="yes">&or;</xsl:text></m:mo><m:mspace width='.3em'/>
    </xsl:for-each>
    <xsl:apply-templates select="child::*[position()=last()]"/>

    </xsl:when>
    <xsl:when test="count(*)=2">
      <m:mspace width='.3em'/><m:mo><xsl:text disable-output-escaping="yes">&or;</xsl:text></m:mo><m:mspace width='.3em'/><xsl:apply-templates select="*[position()=last()]"/>
  </xsl:when>
  <xsl:otherwise>
    <m:mspace width='.3em'/><m:mo><xsl:text disable-output-escaping="yes">&or;</xsl:text></m:mo><m:mspace width='.3em'/>
  </xsl:otherwise>
  </xsl:choose>
</m:mrow>
      ...
      <xsl:when test="parent::m:apply">   
        <m:mfenced>
         ...
         <xsl:for-each select="child::*[position()!=last() and  position()!=1]">
          ...
          <xsl:apply-templates select="."/><m:mo>&xoplus;</m:mo>
         </xsl:for-each>
         <xsl:apply-templates select="child::*[position()=last()]"/>
         </m:mrow>
        </m:mfenced> 
    ...
    <xsl:when test="count(*)=2">
      <xsl:choose>
        <xsl:when test="parent::m:apply">
          ...
          <m:mfenced>
           <m:mrow>
           <m:mo>&xoplus;</m:mo><xsl:apply-templates select="*[position()=last()]"/>
           </m:mrow>
          </m:mfenced>
        </xsl:when>
        <xsl:otherwise>
...
<xsl:template match="m:apply[child::*[position()=1 and local-name()='not']]">
  <m:mrow>
    <m:mo><xsl:text disable-output-escaping="yes">&not;</xsl:text></m:mo>
    <xsl:choose>
...
<xsl:template match="m:apply[child::*[position()=1 and local-name()='implies']]">
  <m:mrow>
    ...
    <xsl:apply-templates select="child::*[position()=2]"/>
    <m:mo><xsl:text disable-output-escaping="yes">&DoubleRightArrow;</xsl:text></m:mo>
    <xsl:apply-templates select="child::*[position()=3]"/>
  </m:mrow>
</xsl:template>
...
<xsl:template match="m:apply[child::*[position()=1 and local-name()='forall']]">
  <m:mrow>
    <m:mo><xsl:text disable-output-escaping="yes">&ForAll;</xsl:text></m:mo>
    <m:mrow>
...
<xsl:template match="m:apply[child::*[position()=1 and local-name()='exists']]">
  <m:mrow>
    <m:mo><xsl:text disable-output-escaping="yes">&Exists;</xsl:text></m:mo>
    <m:mrow>
      <xsl:for-each select="m:bvar[position()!=last()]">
...
<xsl:template match="m:apply[child::*[position()=1 and local-name()='conjugate']]">
  <m:mover>
    <xsl:apply-templates select="child::*[position()=2]"/>
    <m:mo><xsl:text disable-output-escaping="yes">&OverBar;</xsl:text></m:mo>  <!-- does not work, UNICODE x0233D  or perhaps OverBar-->
  </m:mover>
</xsl:template>
...
<xsl:template match="m:apply[child::*[position()=1 and local-name()='arg']]">
  <m:mrow>
    <m:mi>&ang;</m:mi><m:mo><xsl:text disable-output-escaping="yes">&ApplyFunction;</xsl:text></m:mo><m:mfenced separators=" "><xsl:apply-templates select="child::*[position()=2]"/></m:mfenced>
...
<xsl:template match="m:apply[child::*[position()=1 and local-name()='real']]">
  <m:mrow>
    <m:mi><xsl:text disable-output-escaping="yes">&amp;#x0211C;</xsl:text><!-- &Re; or &realpart; should work--></m:mi>
    <m:mo><xsl:text disable-output-escaping="yes">&ApplyFunction;</xsl:text></m:mo>
...
<xsl:template match="m:apply[child::*[position()=1 and local-name()='imaginary']]">
  <m:mrow>
    <m:mi><xsl:text disable-output-escaping="yes">&amp;#x02111;</xsl:text><!-- &Im; or &impartl should work--></m:mi>
    <m:mo><xsl:text disable-output-escaping="yes">&ApplyFunction;</xsl:text></m:mo>
    <m:mfenced separators=" "><xsl:apply-templates select="child::*[position()=2]"/></m:mfenced>
  </m:mrow>
</xsl:template>
...
<xsl:template match="m:apply[child::*[position()=1 and local-name()='floor']]">
  <m:mrow><m:mo><xsl:text disable-output-escaping="yes">&LeftFloor;</xsl:text></m:mo><xsl:apply-templates select="child::*[position()=last()]"/><m:mo><xsl:text disable-output-escaping="yes">&RightFloor;</xsl:text></m:mo></m:mrow>
</xsl:template>

<!-- ceiling -->
<xsl:template match="m:apply[child::*[position()=1 and local-name()='ceiling']]">
  <m:mrow><m:mo><xsl:text disable-output-escaping="yes">&LeftCeiling;</xsl:text></m:mo><xsl:apply-templates select="child::*[position()=last()]"/><m:mo><xsl:text disable-output-escaping="yes">&RightCeiling;</xsl:text></m:mo></m:mrow>
</xsl:template>
...
<xsl:template match="m:apply[child::*[position()=1 and local-name()='neq']]">
  <m:mrow>
    ...
    <xsl:apply-templates select="child::*[position()=2]"/>
    <m:mo><xsl:text disable-output-escaping="yes">&NotEqual;</xsl:text></m:mo>
    <xsl:apply-templates select="child::*[position()=3]"/>
  </m:mrow>
</xsl:template>
...
<xsl:template name="geqRel">
  ...
  <xsl:when test="count(child::*)>=3">
    <m:mrow>
      <xsl:for-each select="child::*[position()!=1 and position()!=last()]">
  <xsl:apply-templates select="."/><m:mo><xsl:text disable-output-escaping="yes">&GreaterEqual;</xsl:text></m:mo>
      </xsl:for-each>
      <xsl:apply-templates select="child::*[position()=last()]"/>
    </m:mrow>
  ...
  <xsl:when test="count(child::*)=2">
    <m:mrow>
      <m:mo><xsl:text disable-output-escaping="yes">&GreaterEqual;</xsl:text></m:mo><xsl:apply-templates select="child::*[position()=2]"/>
    </m:mrow>
  </xsl:when>
  <xsl:otherwise>
    <m:mo><xsl:text disable-output-escaping="yes">&GreaterEqual;</xsl:text></m:mo>
  </xsl:otherwise>
...
<xsl:template name="leqRel">
  ...
  <xsl:when test="count(child::*)>=3">
    <m:mrow>
      <xsl:for-each select="child::*[position()!=1 and position()!=last()]">
  <xsl:apply-templates select="."/><m:mo><xsl:text disable-output-escaping="yes">&leq;</xsl:text></m:mo>
      </xsl:for-each>
      <xsl:apply-templates select="child::*[position()=last()]"/>
    </m:mrow>
  </xsl:when>
  <xsl:when test="count(child::*)=2">
    ...
    <m:mrow>
      <m:mo><xsl:text disable-output-escaping="yes">&leq;</xsl:text></m:mo><xsl:apply-templates select="child::*[position()=2]"/>
    </m:mrow>
  </xsl:when>
  <xsl:otherwise>
    <m:mo><xsl:text disable-output-escaping="yes">&leq;</xsl:text></m:mo>
  </xsl:otherwise>
  </xsl:choose>
</xsl:template>
...
<xsl:template name="equivRel">
  ...
  <xsl:when test="count(child::*)>=3">
    ...
    <m:mrow>
      <xsl:for-each select="child::*[position()!=1 and position()!=last()]">
  <xsl:apply-templates select="."/><m:mo><xsl:text disable-output-escaping="yes">&equiv;</xsl:text></m:mo>
      </xsl:for-each>
      <xsl:apply-templates select="child::*[position()=last()]"/>
    </m:mrow>
  </xsl:when>
  <xsl:when test="count(child::*)=2">
    <m:mrow>
      ...
      <m:mo><xsl:text disable-output-escaping="yes">&equiv;</xsl:text></m:mo><xsl:apply-templates select="child::*[position()=2]"/>
    </m:mrow>
  </xsl:when>
  <xsl:otherwise>
    <m:mo><xsl:text disable-output-escaping="yes">&equiv;</xsl:text></m:mo>
  </xsl:otherwise>
  </xsl:choose>
</xsl:template>
...
<xsl:template match="m:apply[child::*[position()=1 and local-name()='approx']]">
  <m:mrow>
    <xsl:apply-templates select="child::*[position()=2]"/>
    <m:mo><xsl:text disable-output-escaping='yes'>&amp;#x02248;</xsl:text><!-- &TildeTilde; or &approx; should work--></m:mo>
...
<xsl:template match="m:apply[child::*[position()=1 and local-name()='int']]">
  <m:mrow>
    ...
    <xsl:when test="m:condition"> <!-- integration domain expressed by a condition-->
      <m:munder>
        <m:mo><xsl:text disable-output-escaping="yes">&Integral;</xsl:text></m:mo>
  ...
  <xsl:otherwise>
    ...
    <xsl:when test="m:apply/m:ci[@type='fn']">
      ...
      <m:msup>
        ...
        <m:mo accent="true"><xsl:text disable-output-escaping="yes">&prime;</xsl:text></m:mo>
      </m:msup>
        </m:mrow>
  ...
  <xsl:otherwise>
    <xsl:choose>
      <xsl:when test="child::*[local-name()='degree' and position()>0]">
        <m:mfrac>           
    <m:mrow><m:msup><m:mo><xsl:text disable-output-escaping="yes">&PartialD;</xsl:text></m:mo><xsl:apply-templates select="m:degree"/></m:msup></m:mrow>
    <m:mrow>
      ...
      <xsl:choose>         
        <xsl:when test="contains(m:degree/m:cn/text(),'1') and string-length(normalize-space(m:degree/m:cn/text()))=1">
          <m:mrow><m:mo><xsl:text disable-output-escaping="yes">&PartialD;</xsl:text></m:mo><xsl:apply-templates select="*[local-name(.)!='degree']"/></m:mrow>
        </xsl:when>
        <xsl:otherwise> <!-- if order of the derivative is not 1 -->
          <m:mrow><m:mrow><m:mo><xsl:text disable-output-escaping="yes">&PartialD;</xsl:text></m:mo></m:mrow><m:msup><m:mrow><xsl:apply-templates select="*[local-name(.)!='degree']"/></m:mrow><m:mrow><xsl:apply-templates select="m:degree"/></m:mrow></m:msup></m:mrow>

        </xsl:otherwise>
      </xsl:choose>
          </xsl:when>
          <xsl:otherwise> <!-- no order specifiied, default to 1 -->         
      <m:mrow><m:mo><xsl:text disable-output-escaping="yes">&PartialD;</xsl:text></m:mo><xsl:apply-templates select="."/></m:mrow>
          </xsl:otherwise>
        </xsl:choose>
      </xsl:for-each>
    </m:mrow>
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <m:mfrac>
    <m:mrow><m:msup><m:mo><xsl:text disable-output-escaping="yes">&PartialD;</xsl:text></m:mo>
        <m:mrow> 
...
<m:mrow>
  ...
  <xsl:when test="count(*)>=3">
    ...
    <xsl:for-each select="child::*[position()!=last() and  position()!=1]">
      <xsl:apply-templates select="."/><m:mo><xsl:text disable-output-escaping="yes">&Union;</xsl:text></m:mo>
    </xsl:for-each>
    <xsl:apply-templates select="child::*[position()=last()]"/>
  </xsl:when>
  <xsl:when test="count(*)=2">
      <m:mo><xsl:text disable-output-escaping="yes">&Union;</xsl:text></m:mo><xsl:apply-templates select="*[position()=last()]"/>
  </xsl:when>
  <xsl:otherwise>

    <m:mo><xsl:text disable-output-escaping="yes">&Union;</xsl:text></m:mo>
  </xsl:otherwise>
  </xsl:choose>
</m:mrow>
</xsl:template>
...
<m:mrow>
  ...
  <xsl:when test="count(*)>=3">
    <xsl:for-each select="child::*[position()!=last() and  position()!=1]">
      ...
      <xsl:when test="m:union">  <!-- add brackets around UNION children for priority purpose: intersection has higher precedence than union -->
        <m:mfenced separators=" "><xsl:apply-templates select="."/></m:mfenced><m:mo><xsl:text disable-output-escaping="yes">&Intersection;</xsl:text></m:mo>
      </xsl:when>
      <xsl:otherwise>
        <xsl:apply-templates select="."/><m:mo><xsl:text disable-output-escaping="yes">&Intersection;</xsl:text></m:mo>
      </xsl:otherwise>
      </xsl:choose>
  ...
  <xsl:when test="count(*)=2">
      <m:mo><xsl:text disable-output-escaping="yes">&Intersection;</xsl:text></m:mo><xsl:apply-templates select="*[position()=last()]"/>
  </xsl:when>
  <xsl:otherwise>
    <m:mo><xsl:text disable-output-escaping="yes">&Intersection;</xsl:text></m:mo>
  </xsl:otherwise>
...
<m:mrow>
  <xsl:apply-templates select="*[position()=2]"/>
  <m:mo><xsl:text disable-output-escaping="yes">&isin;</xsl:text></m:mo>
  <xsl:apply-templates select="*[position()=3]"/>
</m:mrow>
</xsl:template>
...
<m:mrow>
  <xsl:apply-templates select="*[position()=2]"/>
  <m:mo><xsl:text disable-output-escaping="yes">&notin;</xsl:text></m:mo>
...
<m:mrow>
  ...
  <xsl:when test="count(*)>=3">
    <xsl:for-each select="child::*[position()!=last() and  position()!=1]">
      <xsl:apply-templates select="."/><m:mo><xsl:text disable-output-escaping="yes">&SubsetEqual;</xsl:text></m:mo>
    </xsl:for-each>
    <xsl:apply-templates select="child::*[position()=last()]"/>
    </xsl:when>
    <xsl:when test="count(*)=2">

      <m:mo><xsl:text disable-output-escaping="yes">&SubsetEqual;</xsl:text></m:mo><xsl:apply-templates select="*[position()=last()]"/>
  </xsl:when>
  <xsl:otherwise>
    <m:mo><xsl:text disable-output-escaping="yes">&SubsetEqual;</xsl:text></m:mo>
  </xsl:otherwise>
  </xsl:choose>
</m:mrow>
</xsl:template>
...
<m:mrow>
  ...
  <xsl:when test="count(*)>=3">
    <xsl:for-each select="child::*[position()!=last() and  position()!=1]">
      <xsl:apply-templates select="."/><m:mo><xsl:text disable-output-escaping="yes">&subset;</xsl:text></m:mo>

    </xsl:for-each>
    <xsl:apply-templates select="child::*[position()=last()]"/>
    </xsl:when>
    <xsl:when test="count(*)=2">
      <m:mo><xsl:text disable-output-escaping="yes">&subset;</xsl:text></m:mo><xsl:apply-templates select="*[position()=last()]"/>
  </xsl:when>
  <xsl:otherwise>
    <m:mo><xsl:text disable-output-escaping="yes">&subset;</xsl:text></m:mo>
  </xsl:otherwise>
...
<m:mrow>
  <xsl:apply-templates select="*[position()=2]"/>
  <m:mo><xsl:text disable-output-escaping="yes">&NotSubset;</xsl:text></m:mo>
  <xsl:apply-templates select="*[position()=3]"/>
</m:mrow>
</xsl:template>
...
<m:mrow>
  <xsl:apply-templates select="*[position()=2]"/>
  <m:mo><xsl:text disable-output-escaping="yes">&NotSubsetEqual;</xsl:text></m:mo>  <!-- does not work, perhaps nsube, or nsubE, or nsubseteqq or nsubseteq, UNICODE x02288-->
  <xsl:apply-templates select="*[position()=3]"/>
</m:mrow>
</xsl:template>
...
<m:mrow>
  ...
  <m:mo><xsl:text disable-output-escaping="yes">&Backslash;</xsl:text></m:mo>
  <xsl:apply-templates select="*[position()=3]"/>
</m:mrow>
</xsl:template>
...
<xsl:when test="count(child::*)>=3">
  <m:mrow>
    <xsl:for-each select="child::*[position()!=last() and  position()!=1]">
      <xsl:choose>
      <xsl:when test="m:plus"> <!--add brackets around + children for priority purpose-->
        <m:mfenced separators=" "><xsl:apply-templates select="."/></m:mfenced><m:mo><xsl:text disable-output-escaping="yes">&times;</xsl:text></m:mo>
      </xsl:when>
      <xsl:when test="m:minus"> <!--add brackets around - children for priority purpose-->
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="."/><m:mo><xsl:text disable-output-escaping="yes">&times;</xsl:text></m:mo>
      </xsl:otherwise>
...
<xsl:when test="count(child::*)=2">  <!-- unary -->
  <m:mrow>
    <m:mo><xsl:text disable-output-escaping="yes">&times;</xsl:text></m:mo>
    <xsl:choose>
      <xsl:when test="m:plus">
        <m:mfenced separators=" "><xsl:apply-templates select="*[position()=2]"/></m:mfenced>
...
<m:mrow>
  ...
  <xsl:otherwise>
    <m:munder>
      <m:mo>lim</m:mo>
      <m:mrow><xsl:apply-templates select="m:bvar"/><m:mo><xsl:text disable-output-escaping="yes">&RightArrow;</xsl:text></m:mo><xsl:apply-templates select="m:lowlimit"/></m:mrow>
    </m:munder>
  </xsl:otherwise>
  </xsl:choose>
  <m:mrow><xsl:apply-templates select="*[position()=last()]"/></m:mrow>
...
<m:mrow>
  ...
  <xsl:when test="m:tendsto/@type">
    ...
    <xsl:when test="m:tendsto/@type='above'"> <!-- from above -->
      <xsl:apply-templates select="*[position()=2]"/><m:mo><xsl:text disable-output-escaping="yes">&DownArrow;</xsl:text></m:mo><xsl:apply-templates select="*[position()=3]"/>

    </xsl:when>
    <xsl:when test="m:tendsto/@type='below'"> <!-- from below -->
      <xsl:apply-templates select="*[position()=2]"/><m:mo><xsl:text disable-output-escaping="yes">&UpArrow;</xsl:text></m:mo><xsl:apply-templates select="*[position()=3]"/>
    </xsl:when>
    <xsl:when test="m:tendsto/@type='two-sided'"> <!-- from above or below -->
      <xsl:apply-templates select="*[position()=2]"/><m:mo><xsl:text disable-output-escaping="yes">&RightArrow;</xsl:text></m:mo><xsl:apply-templates select="*[position()=3]"/>
    </xsl:when>
    </xsl:choose>
...
<xsl:template match="m:apply[child::*[position()=1 and local-name()='exp']]">
  <m:msup>
    <m:mi><xsl:text disable-output-escaping="yes">&ee;</xsl:text></m:mi>   <!-- ExponentialE does not work yet -->
    <xsl:apply-templates select="child::*[position()=2]"/>
...
<xsl:template match="m:exp[local-name(preceding-sibling::*[position()=last()])='compose' or local-name(preceding-sibling::*[position()=last()])='inverse']">
  <m:mi><xsl:text disable-output-escaping="yes">&ExponentialE;</xsl:text></m:mi>   <!-- used with inverse or composition; not sure it is appropriate for exponential-->
</xsl:template>
...
<m:mrow>
  ...
  <xsl:when test="count(*)>2">  <!-- if more than one element use angle bracket notation-->
    ...
    <m:mo><xsl:text disable-output-escaping="yes">&lang;</xsl:text></m:mo>
    <xsl:for-each select="*[position()!=1 and position()!=last()]">
      <xsl:apply-templates select="."/><m:mo>,</m:mo>
    </xsl:for-each>
    <xsl:apply-templates select="*[position()=last()]"/>
    <m:mo><xsl:text disable-output-escaping="yes">&rang;</xsl:text></m:mo>  <!-- does not work, UNICODE x03009 or perhaps rangle or RightAngleBracket -->
  </xsl:when>
  ...
  <xsl:apply-templates select="*[position()=last()]"/>
      ...
      <m:mo><xsl:text
      disable-output-escaping="yes">&OverBar;</xsl:text></m:mo>  <!-- does not work, UNICODE x0233D  or perhaps OverBar-->
    </m:mover>
  </xsl:otherwise>
  </xsl:choose>
...
<m:mrow>
  <m:mi><xsl:text disable-output-escaping="yes">&sigma;</xsl:text></m:mi>
  <m:mfenced>
    <xsl:apply-templates select="*[position()!=1]"/>
  </m:mfenced>
</m:mrow>
...
<m:mrow>
  ...
  <m:mo><xsl:text disable-output-escaping="yes">&rang;</xsl:text></m:mo>
</m:mrow> 
</xsl:template>
...
<xsl:template match="m:emptyset">
  <m:mi><xsl:text disable-output-escaping="yes">&empty;</xsl:text></m:mi>
</xsl:template>

<!-- ratio of a circle's circumference to its diameter -->
<xsl:template match="m:pi">
  <m:mi><xsl:text disable-output-escaping="yes">&pi;</xsl:text></m:mi>
</xsl:template>

<!-- Euler's constant -->
<xsl:template match="m:eulergamma">
  <m:mi><xsl:text disable-output-escaping="yes">&gamma;</xsl:text></m:mi>

</xsl:template>

<!-- Infinity -->
<xsl:template match="m:infinity">
  <m:mi><xsl:text disable-output-escaping="yes">&infin;</xsl:text></m:mi>
</xsl:template>
</xsl:stylesheet>
